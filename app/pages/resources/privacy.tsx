      ...
      <DefaultLayout session={session} title="Privacy">
        <Container>
          ...
          <p>
            ...
            person at a place of business. The purpose of this privacy statement
            is to inform you of the personal information that may be collected
            from you when visiting a B.C. government website and how that
          ...
          <p>
            ...
            collections of personal information by a website will be addressed
            in a collection notice on that website.
          </p>

          <p>
            <strong>How&nbsp;is my personal information collected?</strong>
          </p>
          ...
          <p>
            ...
            cookies. A cookie is a small file stored on your computer by your
            web browser when using some websites.
          </p>

          <p>
            <strong>What personal information is being collected?</strong>
          </p>
          ...
          <ul>
            <li>
              The web browser and operating system you are using (e.g. Vista,
              XP, Safari).
            </li>
            ...
            <li>
              ...
              address (e.g. 192.10.100.20) of the computer you are
              using.&nbsp;IP address and domain are identifiers that may be used
              to distinguish between users and identify your internet service
              provider or your computer itself.
            </li>
          </ul>

          <p>
            The B.C. government, via its websites, will notify you if cookies
            will be collecting additional information from you. A cookie may
            remain on your computer after the Internet session finishes (until
            the cookie expires or is deleted by you).
          </p>

          <p>
            The B.C. government collects personal information under the
            authority of section 26(c) of <em>FOIPPA</em> for the purposes
          ...
          <p>
            ...
            Personal information will only be used by authorized staff to
            fulfill the purpose for which it was originally collected or for a
            use consistent with that purpose, unless you expressly consent
            otherwise. The B.C. government collects personal information through
            security audits to protect against threats from hackers, and for
          ...
          <p>
            Your browser may permit you to disable cookies, but you cannot opt
            out of the information collected for audit purposes. Also, your
            decision to disable cookies may impair your ability to browse, read,
            and download information contained on B.C. government websites, and
            government may be unable to personalize your web experience.
            However, you may still be able to access B.C. government services by
            other methods such as personal contact, fax or mail.
          </p>
          ...
          <p>
            ...
            disposal. Specifically, access to systems, applications and the
            collected data is restricted to authorized personnel only.
            Furthermore, any personal information collected and used for
            identifying user trends (e.g. IP address) is aggregated and made
            anonymous during report generation.
          </p>
          ...
          <p>
            ...
            requesting access to it by the ministry holding the information, or
            by submitting a Freedom of Information request. You may request
            changes or annotate your personal information if you believe it to
            be inaccurate by submitting a written request describing the error.
            Please contact the ministry or other government body holding your
            personal information. The&nbsp;Privacy, Compliance and Training
            Branch may be contacted for general information.
          </p>

          <p>
            <strong>
              What about links to external websites from B.C. government
              websites?
            </strong>
          </p>

          <p>
            B.C. government websites may include links to external websites.
            Once you leave a B.C. government website, this privacy statement
            does not apply. The B.C. government is not responsible for the
            privacy practices or content of external websites.
          </p>

          <p>
            <strong>
              Who can I contact for more information about this privacy
              statement?
            </strong>
          </p>
