begin;
  ...
  -- Disable trigger to override default behaviour and manually assign a legacy review_step for the years 2018 & 2019 below
...
declare
    ...
    begin
      for mocked_year in 2018..2025 loop
        ...
        -- Re-enable trigger for years >= 2020 (which is when we started using non-legacy review steps)
        ...
        -- Create <num> applications for all operator types
        ...
        -- Submit applications for Submitted & Changes requested operator
        ...
        loop
          ...
          loop
            ...
            -- Create legacy application_review_steps for applications created in 2018/2019
        ...
        -- Request changes for applications under Changes requested operator
