...
update ggircs_portal.form_result set form_result='{"operator": {"name": "Test operator"}}' where application_id=1 and version_number=1;
update ggircs_portal.form_result set form_result='{"operator": {"name": "Changed"}}' where application_id=1 and version_number=2;
