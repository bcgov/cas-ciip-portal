-- Verify ggircs-portal:tables/ciip_user_002_business_bceid on pg
...
select ggircs_portal_private.verify_grant('update', 'ciip_user', 'ciip_administrator',
  ARRAY['first_name', 'last_name', 'bceid_business_name', 'occupation', 'phone_number', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by']);
