...
select ggircs_portal_private.verify_policy('insert', 'ciip_analyst_insert_review_step', 'review_step_name', 'ciip_analyst');
select ggircs_portal_private.verify_policy('update', 'ciip_analyst_update_review_step', 'review_step_name', 'ciip_analyst');
