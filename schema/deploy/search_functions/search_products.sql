...
returns setof ggircs_portal.product as
        $function$
            begin
              ...
              select
                id, name, description, units, state, parent, product_form_id, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by from outerTable
              where
