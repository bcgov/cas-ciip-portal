            ...
            begin
              if search_field is null or search_value is null
                  ...
                  select
                    ...
                    state, parent, product_form_id, requires_emission_allocation,
              ...
              select
                id, name, description, units, state, parent, product_form_id, requires_emission_allocation, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by from outerTable
              where
