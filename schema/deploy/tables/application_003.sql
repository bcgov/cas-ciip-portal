...
comment on column ggircs_portal.application.swrs_report_id is 'The version of the swrs report this application was populated from. Corresponds to swrs.report.version';
