-- Deploy ggircs-portal:tables/review_step to pg
...
create trigger _100_timestamps
  before insert or update on ggircs_portal.review_step
  for each row
...
comment on column ggircs_portal.review_step.updated_at is 'Timestamp of when this review_step was last updated';
comment on column ggircs_portal.review_step.updated_by is 'The ID of the user who last updated this review_step, references ciip_user.id';
comment on column ggircs_portal.review_step.deleted_at is 'Timestamp of when this review_step was deprecated';
comment on column ggircs_portal.review_step.deleted_by is 'The ID of the user who deprecated this review_step, references ciip_user.id';
