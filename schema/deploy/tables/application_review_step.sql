...
create table ggircs_portal.application_review_step (
  ...
  review_step_name_id integer not null references ggircs_portal.review_step(id),
...
create index ggircs_portal_review_step_application_foreign_key on ggircs_portal.application_review_step(application_id);
create index ggircs_portal_review_step_review_step_name_foreign_key on ggircs_portal.application_review_step(review_step_name_id);
create index ggircs_portal_review_step_created_by_foreign_key on ggircs_portal.application_review_step(created_by);
create index ggircs_portal_review_step_updated_by_foreign_key on ggircs_portal.application_review_step(updated_by);
create index ggircs_portal_review_step_deleted_by_foreign_key on ggircs_portal.application_review_step(deleted_by);
...
comment on column ggircs_portal.application_review_step.review_step_name_id is 'The foreign key ID of the review_step to be applied to this review step';
