...
create table ggircs_portal.form_result_status (
    ...
    foreign key (application_id, version_number, form_id) references ggircs_portal.form_result(application_id, version_number, form_id)
);

create index ggircs_portal_form_result_status_foreign_key on ggircs_portal.form_result_status(application_id, version_number, form_id);
