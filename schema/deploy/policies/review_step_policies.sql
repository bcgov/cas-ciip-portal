...
perform ggircs_portal_private.upsert_policy('ciip_analyst_insert_review_step', 'review_step', 'insert', 'ciip_analyst', 'true');
perform ggircs_portal_private.upsert_policy('ciip_analyst_update_review_step', 'review_step', 'update', 'ciip_analyst', 'true');
