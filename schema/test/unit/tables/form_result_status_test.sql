...
select is_empty(
  $$
    select * from ggircs_portal.form_result_status where application_id= 999;
  $$,
  'Industry User cannot access form_result_status where org access has not been approved'
);
