...
-- Function exists
select has_function(
  'ggircs_portal', 'custom_create_naics_mutation', array['integer', 'text'],
  'Function ggircs_portal.custom_create_naics_mutation should exist'
);

-- Test Setup
select test_helper.clean_ggircs_portal_schema();

select ggircs_portal.custom_create_naics_mutation(1234, 'init');
...
select ggircs_portal.custom_create_naics_mutation(1234, 'updated');
