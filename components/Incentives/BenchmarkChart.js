...
class BenchmarkChart extends Component {
    ...
    componentDidMount() {
        ...
        const max = Math.max(this.props.eligibilityThreshold, this.props.benchmark, this.props.quantity);
    ...
    render(){
        return (
           <canvas width="200px" style={{padding:"20px 0 20px 20px"}} ref={this.canvasRef}></canvas>
       )
    }
