...
class FormCreator extends Component {
    ...
    componentDidUpdate() {
        if(this.props.formData.formJson){
            console.log('SurveyCreator.js > componentDidUpdate', this.props.formData.formJson)
        ...
        commitMutation(
            environment,
            {
                ...
                onCompleted: (response, errors) => {
                    console.log(this.props.formData.formId ? `Form Saved at id ${this.props.formData.formId}`: 'Form Created');
                    alert("Form Saved");
                },
